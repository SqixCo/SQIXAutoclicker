...
class ClickerThread(QThread):
    ...
    def run(self):
        ...
        while self.running:
            self.click_screen()
            self.click_count += 1
            message = f"JJ in action - The ants go marching {self.click_count} by {self.click_count} hurrah, hurrah!"
...
class AutoClickerApp(QWidget):
    ...
    def initUI(self):
        # Setup window
        self.setWindowTitle('JJ AutoClicker - Sqix')
        self.setGeometry(300, 300, 400, 300)
        main_layout = QVBoxLayout()

        # Add JJ's face
        face_label = QLabel(self)
        pixmap = QPixmap('jj_face.png')
        ...
        self.status_label = QLabel('Hi, I am JJ and I am ready to help you play hooky', self)
    ...
    def start_clicking(self):
        ...
        if not self.clicker_thread:
            ...
            message = 'Hi, I am JJ and I am ready to help you play hooky'
            print(message)  # Print to terminal
    ...
    def closeEvent(self, event):
        ...
        if self.clicker_thread:
            self.clicker_thread.stop()
            self.clicker_thread.wait()
        print("JJ is leaving")  # Print to terminal when closing
        event.accept()
